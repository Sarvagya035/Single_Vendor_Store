  ...
  template: `
    <section class="vendor-content">
      <div class="vendor-section">
        ...
        <div *ngIf="isLoadingCategories" class="vendor-section-body text-center">
        ...
        <form *ngIf="!isLoadingCategories" class="space-y-6" (ngSubmit)="submitProduct()">
          ...
          <div *ngIf="currentStep === 1" class="grid grid-cols-1 gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.9fr)]">
          ...
          <div *ngIf="currentStep === 4" class="grid grid-cols-1 gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.9fr)]">
