  ...
  template: `
    <div class="space-y-8">
      <div class="rounded-[2rem] border border-[#eadfce] bg-[linear-gradient(135deg,#fffaf4_0%,#f6ead6_55%,#fff7ef_100%)] px-6 py-7 shadow-[0_28px_70px_rgba(111,78,55,0.12)] lg:px-8">
        ...
        <div class="mt-7 grid gap-3 lg:grid-cols-5">
          <button
      ...
      <form *ngIf="!isLoadingCategories" class="space-y-8" (ngSubmit)="submitProduct()">
        <div *ngIf="currentStep === 0" class="grid gap-8 xl:grid-cols-[1.15fr_0.85fr]">
        ...
        <div *ngIf="currentStep === 1" class="grid gap-8 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <div *ngIf="currentStep === 2" class="grid gap-8 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <div *ngIf="currentStep === 4" class="grid gap-8 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <div class="flex flex-col gap-3 rounded-[1.8rem] border border-slate-200 bg-white px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
