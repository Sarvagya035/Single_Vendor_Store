...
@Component({
  ...
  template: `
    <article class="overflow-visible rounded-[10px] border border-[#e7dac9] bg-white shadow-[0_2px_10px_rgba(0,0,0,0.06)] transition hover:border-[#d4a017] hover:shadow-[0_12px_28px_rgba(0,0,0,0.12)]">
      <div
        role="button"
        tabindex="0"
        (click)="open.emit()"
