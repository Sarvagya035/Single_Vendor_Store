...
@Component({
  ...
  template: `
    <div *ngIf="open" class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-[#2f1b14]/45 px-3 py-3 sm:px-4 sm:py-4">
      <div class="glass-card my-auto w-full max-w-2xl max-h-[calc(100dvh-1.5rem)] overflow-y-auto p-5 shadow-2xl sm:p-8">
