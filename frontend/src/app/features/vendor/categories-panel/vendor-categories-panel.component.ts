          ...
          >
            <div class="category-main">
              ...
              <div class="category-info">
                ...
                <span
                  class="category-status text-xs font-black"
            ...
            <div class="category-actions" (click)="$event.stopPropagation()">
              <button
                ...
                class="category-action-btn text-[#7c5646] hover:border-[#d8c4b0] hover:bg-[#fffaf4]"
              ...
              <button
                ...
                class="category-action-btn category-action-btn-delete hover:bg-rose-50"
