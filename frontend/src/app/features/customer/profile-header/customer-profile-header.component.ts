...
@Component({
  ...
  template: `
    <div class="mb-10 app-section px-6 py-7 sm:px-8">
      <div class="flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
        <div class="min-w-0">
          <p class="text-[11px] font-black uppercase tracking-[0.26em] text-indigo-500">Account Center</p>
        ...
        <div class="flex flex-wrap items-center gap-3 lg:justify-end">
          <div class="inline-flex items-center rounded-full border border-slate-200 bg-white px-4 py-2 text-[11px] font-black uppercase tracking-[0.22em] text-slate-600">
          ...
          <div *ngIf="vendorProfile?.verificationStatus === 'pending'" class="flex items-center gap-2 rounded-full border border-amber-100 bg-amber-50/70 px-4 py-3 text-xs font-bold text-amber-700">
            Review Pending
          </div>
        </div>
      </div>
