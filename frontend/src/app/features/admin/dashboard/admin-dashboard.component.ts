      ...
      <div class="grid gap-5 xl:grid-cols-4">
        <a routerLink="/admin/categories" class="app-card group block p-6 transition hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(14,165,233,0.12)]">
          ...
          <p class="mt-3 text-sm font-medium leading-7 text-slate-500">
            Add, edit, and remove categories from a focused page without extra marketplace overhead.
          </p>
          <p class="mt-5 text-sm font-black text-sky-600">Go to categories</p>
        </a>

        <a routerLink="/admin/products" class="app-card group block p-6 transition hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(139,92,246,0.12)]">
          <p class="text-[10px] font-black uppercase tracking-[0.22em] text-violet-500">Catalog</p>
          <h3 class="mt-3 text-2xl font-black tracking-tight text-slate-900">Manage products</h3>
          <p class="mt-3 text-sm font-medium leading-7 text-slate-500">
            Create and maintain the single-store product catalog from one central page.
          </p>
          <p class="mt-5 text-sm font-black text-violet-600">Go to products</p>
        </a>
        ...
        <a routerLink="/admin/orders" class="app-card group block p-6 transition hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(245,158,11,0.12)]">
          ...
          <p class="mt-3 text-sm font-medium leading-7 text-slate-500">
            Track customer orders, payment status, and revenue from one dedicated page.
          </p>
