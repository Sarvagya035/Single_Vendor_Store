      ...
      <section class="mx-auto w-full max-w-7xl px-3 py-4 sm:px-4 lg:px-6 lg:py-6">
        <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
          <header class="flex items-center justify-between gap-4 border-b border-slate-200 px-5 py-4 sm:px-6">
            <div>
              <p class="text-[11px] font-black uppercase tracking-[0.28em] text-slate-400">Landing page</p>
              <h1 class="mt-1 text-2xl font-black tracking-tight text-slate-900 sm:text-3xl">E-Commerce</h1>
            </div>

            <a
              routerLink="/products"
              class="rounded-full bg-indigo-600 px-5 py-2.5 text-sm font-black text-white shadow-[0_14px_30px_rgba(79,70,229,0.2)] transition hover:-translate-y-0.5 hover:bg-indigo-700"
            >
              All Products
            </a>
          </header>
        ...
        <div
          class="mt-4 relative min-h-[420px] overflow-hidden rounded-[1.8rem] border border-slate-200 text-white shadow-[0_18px_50px_rgba(15,23,42,0.16)]"
        ...
        >
          ...
          <div class="relative grid min-h-[420px] gap-6 px-5 py-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-end lg:px-10 lg:py-10">
            <div class="max-w-2xl">
              <p class="text-[11px] font-black uppercase tracking-[0.3em] text-white/65">Premium dry fruits</p>
              <h2 class="mt-2 text-4xl font-black tracking-tight text-white sm:text-5xl">
                Fresh dry fruits for everyday health.
              </h2>
              <p class="mt-3 max-w-xl text-sm font-medium leading-7 text-white/80">
                Explore almonds, cashews, pistachios, raisins, dates, seeds, and healthy snack mixes curated for your family.
              </p>

              <form class="mt-6 max-w-2xl" (ngSubmit)="goToProducts()">
            ...
            <div class="grid gap-3 sm:grid-cols-2 lg:justify-self-end">
              <div class="rounded-[1.4rem] border border-white/15 bg-white/12 p-4 backdrop-blur-md">
                <p class="text-[10px] font-black uppercase tracking-[0.18em] text-white/65">Dry fruit categories</p>
                <p class="mt-2 text-3xl font-black text-white">{{ catalogCategories.length }}</p>
              </div>
              <div class="rounded-[1.4rem] border border-white/15 bg-white/12 p-4 backdrop-blur-md">
                <p class="text-[10px] font-black uppercase tracking-[0.18em] text-white/65">Featured items</p>
                <p class="mt-2 text-3xl font-black text-white">12</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
                <a
                  *ngFor="let category of catalogCategories; trackBy: trackByCategoryId"
                  ...
                  class="group overflow-hidden rounded-[1.35rem] border border-slate-200 bg-white text-left shadow-sm transition hover:-translate-y-1 hover:border-slate-300 hover:shadow-[0_18px_40px_rgba(15,23,42,0.08)]"
                >
                  ...
                  <div class="space-y-1 p-4">
                    <p class="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">Dry fruit category</p>
